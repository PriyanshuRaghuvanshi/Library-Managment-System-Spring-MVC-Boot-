...
<style>
body {
	background-image: url("https://wallpapercave.com/dwp2x/wp10493680.jpg");
...
<body>
	<div class="wrapper">
		<form action="login" method="post" class="login">
			<h1 class="title">Welcome to Naggaro</h1>
			<p class="subtitle">Login</p>
			<div class="input-container">
				<i class="fa fa-user icon"></i> <input type="text"
					class="input-field" name="username" placeholder="Username"
					autofocus />
			</div>
			<div class="input-container">
